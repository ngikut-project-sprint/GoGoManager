...
import (
	database "github.com/ngikut-project-sprint/GoGoManager/internal/database"
...
func (_m *DB) Query(query string, args ...interface{}) (database.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, ...interface{}) (database.Rows, error)); ok {
		return rf(query, args...)
	}
	if rf, ok := ret.Get(0).(func(string, ...interface{}) database.Rows); ok {
		r0 = rf(query, args...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *DB_Query_Call) Return(_a0 database.Rows, _a1 error) *DB_Query_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DB_Query_Call) RunAndReturn(run func(string, ...interface{}) (database.Rows, error)) *DB_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryRow provides a mock function with given fields: query, args
func (_m *DB) QueryRow(query string, args ...interface{}) database.Row {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	var r0 database.Row
	if rf, ok := ret.Get(0).(func(string, ...interface{}) database.Row); ok {
		r0 = rf(query, args...)
	} else {
		if ret.Get(0) != nil {
...
//   - query string
//   - args ...interface{}
func (_e *DB_Expecter) QueryRow(query interface{}, args ...interface{}) *DB_QueryRow_Call {
	return &DB_QueryRow_Call{Call: _e.mock.On("QueryRow",
		append([]interface{}{query}, args...)...)}
}

func (_c *DB_QueryRow_Call) Run(run func(query string, args ...interface{})) *DB_QueryRow_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_c *DB_QueryRow_Call) Return(_a0 database.Row) *DB_QueryRow_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DB_QueryRow_Call) RunAndReturn(run func(string, ...interface{}) database.Row) *DB_QueryRow_Call {
	_c.Call.Return(run)
	return _c
}
